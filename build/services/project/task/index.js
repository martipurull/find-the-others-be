...
taskRouter.post('/', JWTAuth_1.default, cloudinary_1.parser.single('audioFile'), (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const newTask = new schema_3.default(Object.assign(Object.assign({}, req.body), { musicians: [...musicianObjectIds, (_a = req.payload) === null || _a === void 0 ? void 0 : _a._id], audioFile: ((_b = req.file) === null || _b === void 0 ? void 0 : _b.path) || '', filename: ((_c = req.file) === null || _c === void 0 ? void 0 : _c.filename) || '' }));
...
taskRouter.put('/:taskId', JWTAuth_1.default, cloudinary_1.parser.single('audioFile'), (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _d, _e, _f, _g;
    try {
        const isUserProjectLeader = yield schema_2.default.findOne({ $and: [{ _id: req.params.projectId }, { leader: (_d = req.payload) === null || _d === void 0 ? void 0 : _d._id }] });
        const isUserTaskMusician = yield schema_3.default.findOne({ $and: [{ _id: req.params.taskId }, { musicians: (_e = req.payload) === null || _e === void 0 ? void 0 : _e._id }] });
        if (isUserProjectLeader || isUserTaskMusician) {
            ...
            if (req.body.musicians)
                musicianObjectIds = JSON.parse(req.body.musicians).map((musicianId) => new mongoose_1.default.Types.ObjectId(musicianId));
            const body = Object.assign(Object.assign({}, req.body), { musicians: musicianObjectIds, audioFile: ((_f = req.file) === null || _f === void 0 ? void 0 : _f.path) || oldTask.audioFile, filename: ((_g = req.file) === null || _g === void 0 ? void 0 : _g.filename) || oldTask.filename });
...
taskRouter.delete('/:taskId', JWTAuth_1.default, (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _h, _j;
    try {
        const isUserProjectLeader = yield schema_2.default.findOne({ $and: [{ _id: req.params.projectId }, { leader: (_h = req.payload) === null || _h === void 0 ? void 0 : _h._id }] });
        const isUserTaskMusician = yield schema_3.default.findOne({ $and: [{ _id: req.params.taskId }, { musicians: (_j = req.payload) === null || _j === void 0 ? void 0 : _j._id }] });
        if (isUserProjectLeader || isUserTaskMusician) {
...
taskRouter.put('/:taskId/drag', JWTAuth_1.default, (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _k, _l;
    try {
        const isUserProjectLeader = yield schema_2.default.findOne({ $and: [{ _id: req.params.projectId }, { leader: (_k = req.payload) === null || _k === void 0 ? void 0 : _k._id }] });
        const isUserTaskMusician = yield schema_3.default.findOne({ $and: [{ _id: req.params.taskId }, { musicians: (_l = req.payload) === null || _l === void 0 ? void 0 : _l._id }] });
        if (isUserProjectLeader || isUserTaskMusician) {
...
taskRouter.post('/:taskId/notes', JWTAuth_1.default, (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _m, _o;
    try {
        const sender = yield schema_1.default.findById((_m = req.payload) === null || _m === void 0 ? void 0 : _m._id);
        if (!sender)
            return next((0, http_errors_1.default)(404, `User with id ${(_o = req.payload) === null || _o === void 0 ? void 0 : _o._id} could not be found.`));
...
taskRouter.put('/:taskId/notes/:noteId', JWTAuth_1.default, (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (!task)
            return next((0, http_errors_1.default)(404, `Task with id ${req.params.taskId} was not found.`));
        const noteIndex = (_p = task.notes) === null || _p === void 0 ? void 0 : _p.findIndex(n => n._id.toString() === req.params.noteId);
        console.log(noteIndex);
        if (noteIndex && noteIndex !== -1) {
            if (task.notes[noteIndex].sender._id.toString() === ((_q = req.payload) === null || _q === void 0 ? void 0 : _q._id)) {
...
taskRouter.delete('/:taskId/notes/:noteId', JWTAuth_1.default, (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (!task)
            return next((0, http_errors_1.default)(404, `Task with id ${req.params.taskId} was not found.`));
        const noteIndex = (_r = task.notes) === null || _r === void 0 ? void 0 : _r.findIndex(n => n._id.toString() === req.params.noteId);
        console.log(noteIndex);
        if (noteIndex && noteIndex !== -1) {
